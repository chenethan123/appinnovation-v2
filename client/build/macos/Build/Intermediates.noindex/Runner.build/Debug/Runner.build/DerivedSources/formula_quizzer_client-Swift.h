...
#ifndef FORMULA_QUIZZER_CLIENT_SWIFT_H
#define FORMULA_QUIZZER_CLIENT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="formula_quizzer_client",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC22formula_quizzer_client11AppDelegate")
...
SWIFT_CLASS("_TtC22formula_quizzer_client17MainFlutterWindow")
